...
const Page_Designer = () => {
  ...
  return (
    ...
    <div style={{width: "100%", height: '100%'}}>
      <Split mode="vertical" style={{ width: "100%", height: '100%', border: '1px solid #d5d5d5', borderRadius: 3 }}>
        <div id="top_container_toolbar_tabs_and_button" style={{ width: "100%", backgroundColor: "#d1cfcd", height: "10%", display:"block" }} className='border border-1'>        
          <div  id="top_container_toolbar_tabs" style={{ width: "100%" }}>
            <Button>Конструктор</Button>           
            <Button>Генератор</Button> 
        ...
        <div id="bottom_container" style={{ height: "20%"}}>
